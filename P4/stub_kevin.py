...
class Learner(object):
    ...
    def __init_state(self):
        ...
        #tree_bot = [100, 200, INF]
        monkey_top = [50, 100, 150, 200, 250, 300, 350, INF]
        #monkey_bot = [50, 100, 150, 200, 300, INF]
    ...
    def state_transformation(self, state):
        ...
        if state == None:
            ...
            #state_list.append(state['tree']['bot'])
            state_list.append(state['monkey']['top'])
            #state_list.append(state['monkey']['bot'])
...
if __name__ == '__main__':
    ...
    #state_space_size = np.prod([len(b) for b in agent.coarse_bounds])
    ...
    # data = [etas,gammas,epsilons,max_scores]
    # np.savetxt('master_run.csv', np.array(data).T, fmt = '%.3f')
